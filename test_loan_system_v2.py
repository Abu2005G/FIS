"""
Test script for the Credit Risk Assessment System - V2
Fixed date format for proper month grouping
"""
import json
import sys
...
# Sample transaction data with DD/MM/YY format
sample_transactions = [
    # Month 1 (Jan)
...
def test_feature_extraction():
    ...
    print("=" * 60)
    print("TEST 1: Feature Extraction - Stable Income Applicant")
    print("=" * 60)
    ...
    print(f"  Max Balance: ${features.max_balance:,.2f}")
    print(f"  Balance Trend: ${features.balance_trend:,.2f}")
    print(f"  Savings Rate: {features.savings_rate:.2%}")
    print(f"  Debt-to-Income: {features.debt_to_income:.2%}")
    print(f"  Expense-to-Income: {features.expense_to_income:.2%}")
    print(f"  Negative Balance Count: {features.negative_balance_count}")
...
def test_high_risk_scenario():
    ...
    high_risk_transactions = [
        ...
        {"date": "02/01/24", "description": "RENT PAYMENT", "withdrawal": 12000.00, "deposit": None, "balance": -7000.00},
        ...
        {"date": "15/01/24", "description": "LOAN REPAYMENT", "withdrawal": 8000.00, "deposit": None, "balance": -5500.00},
        {"date": "20/01/24", "description": "PAYDAY LOAN", "withdrawal": None, "deposit": 5000.00, "balance": -500.00},
        {"date": "25/01/24", "description": "CREDIT CARD BILL", "withdrawal": 15000.00, "deposit": None, "balance": -15500.00},
...
def test_medium_risk_scenario():
    """Test with a medium-risk applicant (borderline case)."""
    print("\n" + "=" * 60)
    print("TEST 4: Medium-Risk Applicant Scenario (Borderline)")
    print("=" * 60)

    # Medium-risk: stable but high debt
    medium_risk_transactions = [
        {"date": "01/01/24", "description": "SALARY", "withdrawal": None, "deposit": 40000.00, "balance": 10000.00},
        {"date": "02/01/24", "description": "RENT", "withdrawal": 12000.00, "deposit": None, "balance": -2000.00},
        {"date": "05/01/24", "description": "CAR LOAN EMI", "withdrawal": 8000.00, "deposit": None, "balance": -10000.00},
        {"date": "10/01/24", "description": "GROCERIES", "withdrawal": 5000.00, "deposit": None, "balance": -15000.00},
        {"date": "15/01/24", "description": "CREDIT CARD PAYMENT", "withdrawal": 10000.00, "deposit": None, "balance": -25000.00},
        {"date": "20/01/24", "description": "OVERDRAFT COVER", "withdrawal": None, "deposit": 25000.00, "balance": 0.00},
        {"date": "01/02/24", "description": "SALARY", "withdrawal": None, "deposit": 40000.00, "balance": 40000.00},
        {"date": "02/02/24", "description": "RENT", "withdrawal": 12000.00, "deposit": None, "balance": 28000.00},
        {"date": "05/02/24", "description": "CAR LOAN EMI", "withdrawal": 8000.00, "deposit": None, "balance": 20000.00},
        {"date": "10/02/24", "description": "GROCERIES", "withdrawal": 5000.00, "deposit": None, "balance": 15000.00},
        {"date": "15/02/24", "description": "CREDIT CARD PAYMENT", "withdrawal": 10000.00, "deposit": None, "balance": 5000.00},
        {"date": "01/03/24", "description": "SALARY", "withdrawal": None, "deposit": 40000.00, "balance": 45000.00},
        {"date": "02/03/24", "description": "RENT", "withdrawal": 12000.00, "deposit": None, "balance": 33000.00},
        {"date": "05/03/24", "description": "CAR LOAN EMI", "withdrawal": 8000.00, "deposit": None, "balance": 25000.00},
        {"date": "10/03/24", "description": "GROCERIES", "withdrawal": 5000.00, "deposit": None, "balance": 20000.00},
    ]

    features = extract_features_from_transactions(medium_risk_transactions)
    model = CreditRiskModel()
    prediction = model.predict(features)
...
def main():
    print("\n" + "=" * 60)
    print("CREDIT RISK ASSESSMENT SYSTEM - TEST SUITE V2")
    print("=" * 60)
